...
* Obtain the plugin binary jar file; either:
     ...
     * Build the plugin from source: https://github.com/fortify/fortify-ssc-parser-tenable-io-cs/CONTRIB.md
...
`fcli ssc appversion-artifact upload <raw-results-file> --appversion MyApp:MyVersion --engine-type TENABLE_IO_CS`
