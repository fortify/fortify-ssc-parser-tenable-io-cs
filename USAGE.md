...
# Fortify SSC Parser Plugin for Tenable.io Container Security - Usage
...
* Obtain the plugin binary jar file; either:
     * Download from the repository release page: https://github.com/fortify/fortify-ssc-parser-tenable-io-cs/releases
     * Build the plugin from source: https://github.com/fortify/fortify-ssc-parser-tenable-io-cs/blob/main/CONTRIBUTING.md
...
`fcli ssc artifact upload -f <raw-results-file> --appversion MyApp:MyVersion --engine-type TENABLE_IO_CS`
